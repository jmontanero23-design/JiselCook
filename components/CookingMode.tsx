...
import { X, ChevronLeft, ChevronRight, Volume2, VolumeX, CheckCircle, Star, Send, Mic, MicOff, Loader2, Camera, UserCog, Heart, Flame, Bot, ChefHat } from 'lucide-react';
                        ...
                        {[1, 2, 3, 4, 5].map((star) => (
                            <button
                                ...
                                className={`p-1 transition-transform hover:scale-110 ${
                                    star <= userRating ? 'text-amber-400' : 'text-slate-200'
                                }`}
                            >
        ...
        <div className="flex items-center space-x-2">
             ...
             <button
                ...
                className={`p-2 rounded-full transition-all ${
                    isVideoEnabled ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'
                }`}
             ...
             <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-full font-medium transition-colors ${
                  isSpeaking ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                }`}
             >
